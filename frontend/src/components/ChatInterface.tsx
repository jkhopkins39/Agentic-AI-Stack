...
export const ChatInterface: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-screen max-w-4xl mx-auto p-4 bg-gray-50">
      {/* Header */}
      <div className="bg-white rounded-t-2xl shadow-sm border-b border-gray-200 p-6">
        <h1 className="text-2xl font-bold text-gray-800 text-center">
          Multi-Agent LLM Assistant
        </h1>
        <p className="text-gray-600 text-center mt-2">
          Powered by specialized AI agents for orders, policies, and support
        </p>
      </div>
      
      {/* Messages Container */}
      <div className="flex-1 bg-white shadow-sm border-x border-gray-200 overflow-y-auto p-6 space-y-4">
      ...
      {/* Input Container */}
      <div className="bg-white rounded-b-2xl shadow-sm border-t border-gray-200 p-6">
